...
#define HOMING_BUMP_MM      { 5, 5, 5 }   //!HERE     // (mm) Backoff from endstops after first bump
 ...
 */
   ...
   */
  #define INTERPOLATE      true //!HERE

  #if AXIS_IS_TMC(X)
    #define X_CURRENT       750 //!HERE        // (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  X_CURRENT  // (mA) RMS current for sensorless homing
    #define X_MICROSTEPS     16     //!HERE   // 0..256
    #define X_RSENSE          0.11 //!HERE
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       750 //!HERE
    #define Y_CURRENT_HOME  Y_CURRENT
    #define Y_MICROSTEPS     16 //!HERE
    #define Y_RSENSE          0.11 //!HERE
   ...
   */
  // #define MONITOR_DRIVER_STATUS //!HERE
   ...
   */
  #define SENSORLESS_HOMING //!HERE // StallGuard capable drivers only

  #if EITHER(SENSORLESS_HOMING, SENSORLESS_PROBING)
    // TMC2209: 0...255. TMC2130: -64...63
    #define X_STALL_SENSITIVITY  130 //!HERE
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  130 //!HERE
